...
\begin{thm}[Forma vettoriale]\index{Fibonacci!vettore}
	...
	\end{equation}
\end{thm}
\begin{thm}[Forma matriciale]\index{Fibonacci!matrice}\index{Matrice!Q}
Se $\Fib{n}$ è la successione di Fibonacci allora avremo:
\begin{equation}
Q^n=\begin{bmatrix}
...
Cassini]\index{Fibonacci!identità!Cassini}\index{Cassini}
	Se $\Fib{n}$ è la successione di Fibonacci allora avremo:
...
generalizzata]\label{thm:identitàCassinigeneralizzatamatrici}
	...
	\end{equation}
\end{thm}\index{Fibonacci!identità!Cassini generalizzata}\index{Cassini}
\begin{proof}
